    ...
    public class App
    {
        ...
        public void Run()
        {
            try
            {
                ...
                //if (_args[0] == typeof(ModelosCargas.CargaSala01).Name) new ModelosCargas.CargaSala01(this.Configuration, _logger, _spinner).ProcessarCarga(_args.ToArray().Contains("-a"));
